...
public class Game 
{
    ...
    {
        Room outside, bombSite, baracades, hallway, defuserSite;
      
        // create the rooms
        outside = new Room("outside the building");
        bombSite = new Room("in bomb room");
        baracades = new Room("a blocked of room");
        hallway = new Room("A long hall to get to the defuser");
    ...
    private void printlocationInfo(){ //current room description
